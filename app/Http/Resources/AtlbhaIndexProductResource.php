...
class AtlbhaIndexProductResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        if ($this->is_import == 1) {
            ...
            return [
                ...
                'selling_price' => $firstImportProduct !== null ? $firstImportProduct->price:$this->selling_price,
                ...
                'url' => 'https://template.atlbha.sa/' . $domain . '/shop/product/' . $this->id .'/'.preg_replace('/ /', '-',$this->name),
                'amount' => $this->amount,

...
class ImportsProductSearchResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'status' =>  $this->status == null || $this->status == 'active' ? _('message.active'):_('message.not_active'),
            'special' => $this->special == null ||$this->special  == 'special' ? _('message.special'):_('message.not_special'),

...
class PageResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'seo_link' =>$this->store_id == null ? 'https://atlbha.sa/pages/' . preg_replace('/[^a-zA-Z0-9\x{0621}-\x{064A}]+/u', '-', $this->title) : 'https: //template.atlbha.com/' . $this->store->domain . '/site/SitePages/' . $this->id,
            ...
            // 'page_url' => $this->store_id == null ? 'https://atlbha.sa/pages/' . preg_replace('/[^a-zA-Z0-9\x{0621}-\x{064A}]+/u', '-', $this->title) : 'https: //template.atlbha.com/' . $this->store->domain . '/site/SitePages/' . $this->id,

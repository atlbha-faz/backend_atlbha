...
class StoreController extends BaseController
{
    ...
    $query->select('id');
}])->where('is_deleted', 0)->orderByDesc('created_at')->select('id','store_name','domain','status','periodtype','logo'.'special','verification_status','verification_date','created_at')->get());
        $success['status'] = 200;

...
class SelectorController extends BaseController
{
    ...
    public function updatePage()
    {
        ...
        $privatePages = Page::where('title','سياسة الخصوصية')->where('is_deleted', 0)->get();
        ...
        $pages = Page::where('title','اتفاقية الاستخدام')->where('is_deleted', 0)->get();
        ...
        return $this->sendResponse($success, 'تم التعديل', 'updated successfully');

...
class PostController extends BaseController
{
    ...
    {
        $postCategory_id = Page::where('is_deleted', 0)->where('store_id', null)->where('postcategory_id', $postCategory_id)->first();
    ...
    {
        $post = Page::where('is_deleted', 0)->where('store_id', null)->where('postcategory_id', '!=', null)->where('id', $id)->first();
        if ($post != null) {

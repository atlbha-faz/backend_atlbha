...
{
    use HasFactory;
    protected $fillable = ['google_analytics', 'snappixel', 'tiktokpixel','twitterpixel', 'instapixel', 'metaDescription','header', 'footer','graph','tag','search','title', 'key_words', 'store_id', 'status', 'is_deleted'];

...
{
    use HasFactory;
    protected $fillable = ['google_analytics', 'snappixel', 'tiktokpixel' ,'twitterpixel', 'instapixel', 'metaDescription', 'key_words','title', 'header', 'footer','graph','tag','search','store_id', 'status', 'is_deleted'];

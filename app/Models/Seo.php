...
{
    use HasFactory;
    protected $fillable = ['google_analytics', 'snappixel', 'tiktokpixel','robot_link' ,'twitterpixel', 'instapixel', 'metaDescription', 'key_words','title', 'header', 'footer', 'siteMap','store_id', 'status', 'is_deleted'];

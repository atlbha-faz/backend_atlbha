...
{
    use HasFactory;
    protected $fillable = ['google_analytics', 'snappixel', 'tiktokpixel','robot_link' ,'twitterpixel', 'instapixel', 'metaDescription','header', 'footer', 'siteMap','title', 'key_words', 'store_id', 'status', 'is_deleted'];

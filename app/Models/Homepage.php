...
class Homepage extends Model implements Viewable
{
    ...
    public function getBanar1Attribute($banar1)
    {
        ...
        if (filter_var($banar1, FILTER_VALIDATE_URL)) {
            return $banar1;} else {
    ...
    public function getBanar3Attribute($banar3)
    {
        ...
        if (filter_var($banar3, FILTER_VALIDATE_URL)) {
            return $banar3;} else {
    ...
    public function getSlider1Attribute($slider1)
    {
        ...
        if (filter_var($slider1, FILTER_VALIDATE_URL)) {
            return $slider1;} else {
    ...
    public function getSlider2Attribute($slider2)
    {
        ...
        if (filter_var($slider2, FILTER_VALIDATE_URL)) {
            return $slider2;} else {
    ...
    public function getSlider3Attribute($slider3)
    {
        ...
        if (filter_var($slider3, FILTER_VALIDATE_URL)) {
            return $slider3;} else {

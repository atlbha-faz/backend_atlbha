...
Route::prefix('madfu')->group(function () {
    ...
    Route::post('sendStoresInfo', [MadfuController::class, 'sendStoresInfo']);
});
...
Route::post('initiateSession', [App\Http\Controllers\api\storeTemplate\FatoorahSessionController::class, 'initiateSession']);
Route::post('updateSession', [App\Http\Controllers\api\storeTemplate\FatoorahSessionController::class, 'updateSession']);
...
Route::middleware([AdminUser::class])->group(function () {
    Route::prefix('/Admin')->group(function () {
        ...
        Route::get('searchPlanName',[App\Http\Controllers\api\adminDashboard\PlanController::class,'deleteAll']);
